...
begin
  ...
  if DM.qryTemp.FieldByName('numjogadas').AsInteger >= 1 then
    dCalculo := DM.qryTemp.FieldByName('mediageral').AsFloat/DM.qryTemp.FieldByName('numjogadas').AsInteger
  else
    dCalculo := 0;
  ...
  lblTotalPontos.Text := FormatFloat('0.00', dCalculo);
